...
down 8
forward 2
Your horizontal position and depth both start at 0. The steps above would the
...
After following these instructions, you would have a horizontal position of 1
